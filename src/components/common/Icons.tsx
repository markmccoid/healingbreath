...
export const ViewMovieIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <MaterialIcons name="movie" size={size} color={color} style={style} />;
};
export const ViewTVShowIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <Feather name="tv" size={size} color={color} style={style} />;
};
export const EyeEmptyIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <AntDesign name="eye" size={size} color={color} style={style} />;
};
export const EyeFilledIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <AntDesign name="eye" size={size} color={color} style={style} />;
};
export const EyeWatchedIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <MaterialCommunityIcons name="eye-check" size={size} color={color} style={style} />;
};
export const EyeNotWatchedIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <MaterialCommunityIcons name="eye-off" size={size} color={color} style={style} />;
};
export const TelevisionOffIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return (
    <MaterialCommunityIcons name="television-off" size={size} color={color} style={style} />
  );
};
export const TelevisionIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <MaterialCommunityIcons name="television" size={size} color={color} style={style} />;
};

export const SearchIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <MaterialIcons name="search" size={size} color={color} style={style} />;
};

export const DragHandleIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <MaterialIcons name="drag-handle" size={size} color={color} style={style} />;
};

export const TagIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <FontAwesome name="tags" color={color} size={size} style={style} />;
};
export const GenreIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <MaterialCommunityIcons name="tag-faces" color={color} size={size} style={style} />;
};

export const UnTagIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <Entypo name="untag" color={color} size={size} style={style} />;
};

export const ShareIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <Entypo name="share-alternative" size={size} color={color} style={style} />;
};

export const IMDBIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <Fontisto name="imdb" size={size} color={color} style={style} />;
};
export const FilterIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return (
    <Feather
      name="filter"
      size={size}
...
export const EraserIcon = ({ size = 25, color = undefined, style = {} }: IconProps) => {
  return <MaterialCommunityIcons name="eraser" size={size} color={color} style={style} />;
};

export const RefreshIcon = ({ size = 25, color = undefined, style = {} }: IconProps) => {
  return <FontAwesome name="refresh" size={size} color={color} style={style} />;
};
export const HardDriveIcon = ({ size = 25, color, style = {} }: IconProps) => {
  return <Feather name="hard-drive" size={size} color={color} style={style} />;
};

//OLD Check icon has circle around it
// export const CheckIcon = ({ size, color = undefined, style = {}}: IconProps) => {
//   return (
...
export const UnCheckedBox = ({ size, color = undefined, style = {} }: IconProps) => {
  // return <FontAwesome5 name="sync-alt" size={size} color={color} style={style} />;
  return (
...
export const BackIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <AntDesign name="back" size={size} color={color} style={style} />;
};
//----------------
//- Drawer Icons
//----------------
export const SignOutIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <FontAwesome name="sign-out" color={color} size={size} style={style} />;
};
export const HomeIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <FontAwesome name="home" color={color} size={size} style={style} />;
};
export const SettingsIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <Ionicons name="ios-settings" color={color} size={size} style={style} />;
};
export const UserIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <FontAwesome name="user" color={color} size={size} style={style} />;
};
//Plus sign icon
export const AddIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <Ionicons name="ios-add" color={color} size={size} style={style} />;
};
export const EmptyMDHeartIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return (
    <MaterialCommunityIcons name="heart-outline" color={color} size={size} style={style} />
  );
};
export const MDHeartIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <Ionicons name="ios-heart" color={color} size={size} style={style} />;
};

// Other Icons

export const ThumbsUpIcon = ({ size, color = undefined, style = {} }: IconProps) => {
  return <Ionicons name="ios-thumbs-up" color={color} size={size} style={style} />;
};

export const YouTubePlayIcon = ({ size, color = undefined, style = {} }: IconProps) => {
